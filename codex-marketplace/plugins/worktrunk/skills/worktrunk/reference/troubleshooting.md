...
Codex and general terminal troubleshooting guidance for common Worktrunk issues.
...
which codex     # or: which llm, which aichat, which claude
```
...
3. Verify template variables expand correctly (`wt hook show --expanded`)
